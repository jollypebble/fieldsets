 ...
 * @param object{string,object} display{setview,attributes{}} - Display parameters includig tHe setview to display on the x,y coordinate and any attibutes needed for that setview.
 */
const valueDefaults = {
  id: 'default',
  name: 'default',
  ...
  children: [],
  display: {
    setview: 'Circle', // The setview setview
    attributes: {
      textSize: 0.6,
      ratio: 1
    }, // setview attributes
